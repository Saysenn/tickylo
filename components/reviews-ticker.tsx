...
const reviews = [
  {
    ...
    rating: 5,
    text: "We finally know exactly how many billable hours go into each client. Invoicing used to be a guess — now it's a report. PerformAI paid for itself in week one.",
    date: "2 weeks ago",
  },
  {
    name: "James Okafor",
  ...
  },
  {
    ...
    rating: 5,
    text: "Our freelancers are spread across time zones. PerformAI gives us one view of output and hours without chasing anyone for updates. Huge time saver.",
    date: "3 weeks ago",
  },
  {
    name: "Marcus Webb",
    ...
    rating: 5,
    text: "We replaced three separate tools with PerformAI. Billable hours, task tracking, and team reports all in one place. The team adopted it within a day.",
    date: "2 months ago",
  },
  {
    name: "Amara Nwosu",
