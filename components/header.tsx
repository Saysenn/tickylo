    ...
    <nav className="glass border-b sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-4 py-3.5 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <Button asChild className="bg-mint hover:bg-mint-hover text-ink font-semibold shadow-[0_2px_12px_rgba(128,237,153,0.30)]">
              <Link href="/dashboard">Dashboard</Link>
            </Button>
          ) : (
            <>
              <Button asChild variant="ghost" className="text-ink-2 hover:bg-mint/10 hover:text-ink">
