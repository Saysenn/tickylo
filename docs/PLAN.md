...
1. **Employee Dashboard** — Replace "My Active Tasks" card with Time Logged This Week; wire "My Requests" card to a new `/dashboard/requests` page with cancel support + employee sidebar nav item
