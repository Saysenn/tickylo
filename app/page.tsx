...
const features = [
	{
		...
		description:
			"Log every hour worked per project and client. Generate accurate billable reports your clients will trust.",
	},
	{
		icon: BarChart2,
		title: "Deadline & Output Reports",
		description:
			"See who delivered what and when. Catch bottlenecks before they blow a deadline.",
	},
	{
		icon: BrainCircuit,
		title: "AI-Powered Insights",
		description:
			"Surface patterns in your team's output — see who's overloaded, who's underutilised, and where time is being lost.",
	},
];
				...
				<section className="relative z-10 max-w-4xl mx-auto px-4 pb-24">
					<div className="glass rounded-2xl p-10 text-center shadow-[0_4px_30px_rgba(128,237,153,0.10)]">
						...
						<p className="text-sm text-ink-3 mb-8 max-w-md mx-auto leading-relaxed">
							...
							card, no commitment — and help shape the product.
						</p>
