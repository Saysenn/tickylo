  ...
  return (
    <div className="max-w-5xl space-y-6">
      <div>
        ...
        <p className="text-ink-3 mt-1 text-sm">Log hours, track project time, and manage timesheets.</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-sm text-ink-3 max-w-xs">Start logging time to see your entries and timesheets here.</p>
      </div>
    </div>
  );
}
