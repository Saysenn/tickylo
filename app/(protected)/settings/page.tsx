  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      <div>
        ...
        <p className="text-ink-3 mt-1 text-sm">Manage your account and security preferences.</p>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  <p className="font-semibold text-ink">{name ?? "No name set"}</p>
                  <Badge className="bg-mint/20 text-ink-2 hover:bg-mint/20 border-0 text-xs">
                    Active
                  </Badge>
                </div>
                <p className="text-sm text-ink-3 truncate mt-0.5">{user.email}</p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xs text-ink-3 truncate max-w-[160px]">{user.id}</span>
              </div>
              <div className="flex items-center justify-between">
